...
#@cog_i18n(_)
class BearModlog(EventMixin, commands.Cog):
    """
        Extended modlogs, specific to redbear and sub cogs
        Works with core modlogset channel
    """

    #__author__ = ["RePulsar", "TrustyJAID"] amici-ursi and strentax forked and extended this. props to the OGs.
    #__version__ = "2.8.8"
